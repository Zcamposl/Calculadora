...
public class Calculadora extends javax.swing.JFrame {
    ...
    private void jButton19ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton19ActionPerformed
        ...
        switch(this.operacion){
            case "+" :
                this.casilla.setText(sin0(this.numero1+this.numero2));
                break;
            case "-" :
                this.casilla.setText(sin0(this.numero1-this.numero2));
                break;
            case "*" :
                ...
                break;
            case "/" :
                if (this.numero2 == 0){this.casilla.setText("No se puede dividir entre 0");}
                else{
                this.casilla.setText(sin0(this.numero1/this.numero2));
                break;}
        }
    ...
    public String sin0 (float resultado){
        String retorno = "";
